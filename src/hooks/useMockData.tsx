...
const mockUBS: UBS[] = [
  ...
  {
    id: '3',
    nome: 'Hospital Regional de Água Quente',
    endereco: 'Rua 10, Lote 1, Água Quente',
    cep: '71916-000',
...
const mockPacientes: Paciente[] = [
  ...
  },
  {
    ...
    cns: '456789123456789',
    endereco: 'Rua 12, Casa 45, Água Quente',
    cep: '71916-012',
  ...
  const getEstatisticas = (): Estatisticas => {
    ...
    return {
      ...
      coberturaPorRegiao: {
        ...
        'Água Quente': pacientesList.filter(p => p.endereco.includes('Água Quente')).length,
      },
